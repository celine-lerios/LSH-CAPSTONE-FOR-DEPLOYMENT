                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt_10 pb_10">
                                            ...
                                            {{-- <a href="{{ route('admin_order_confirm',$row->id) }}" class="btn btn-success mb-1" onClick="return confirm('Are you sure you want to confirm the declined booking?');" data-toggle="tooltip" data-placement="top" title="Confirm">
