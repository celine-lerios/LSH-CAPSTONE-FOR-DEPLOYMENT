                            ...
                            <table class="table table-bordered" id="example1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td>{{ \Carbon\Carbon::createFromFormat('d/m/Y', $check_date->checkin_date)->format('F d, Y') }} - {{ \Carbon\Carbon::createFromFormat('d/m/Y', $check_date->checkout_date)->format('F d, Y') }}
                                        </td> --}}
