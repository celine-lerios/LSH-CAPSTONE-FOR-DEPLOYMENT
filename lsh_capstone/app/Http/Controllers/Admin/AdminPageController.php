...
class AdminPageController extends Controller
{
    ...
    public function about()
    {
        ...
        // Retrieve data for the About page
        return view('admin.about_page', compact('about_data'));
        // Return the view for the About page with the data
    }

        // Function to update the About page
    public function about_update(Request $request)
    {
        // Retrieve the existing About page data
        $obj = Page::where('id',1)->first();

         // Update the About page data with the new values from the request
