...
class CustomerAuthController extends Controller
{
    ...
    public function signup_submit(Request $request)
    {
        ...
        if($request->hasFile('id_image') || $request->hasFile('selfie')) {
            $request->validate([
                'id_image' => 'image|mimes:jpg,jpeg,png,gif,svg,webp|max:5120',
                'selfie' => 'image|mimes:jpg,jpeg,png,gif,svg,webp|max:5120',
            ]);
            ...
            $request->file('id_image')->move(public_path('uploads/'),
            $final_id_image_name);

            $request->file('selfie')->move(public_path('uploads/'),
            $final_selfie_image_name);
