            ...
            $d2_new = $d2[2] . '-' . $d2[1] . '-' . $d2[0];
              ...
              while (1) {
               ...
               if ($cart_total_guest > $room_total_guest) {
                   ...
                   return redirect()->back()->with('error', 'There were only ' . 
                   $room_total_guest . ' guests allowed to book in this room!');
                }
             ...
             if ($count == 0) {
                ...
                return redirect()->back()->with('error', 'This room is already occupied.');
            }
