                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="province" value="<?php echo e(Auth::guard('customer')->user()->province); ?>">
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('customer.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/customer/profile.blade.php ENDPATH**/ ?>