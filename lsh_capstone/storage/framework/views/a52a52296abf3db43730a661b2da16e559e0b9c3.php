                            ...
                            <table class="table table-bordered" id="example1">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt_10 pb_10">
                                            <a href="<?php echo e(route('customer_invoice',$row->id)); ?>" class="btn btn-info mb-1" data-toggle="tooltip" data-placement="top" title="Detail"><i class="fa fa-sticky-note-o" aria-hidden="true"></i></a>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/admin/declined_orders.blade.php ENDPATH**/ ?>