...
<?php $__env->startSection('heading', 'Accommodation Reviews'); ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt_10 pb_10">
                                            ...
                                            <a href="<?php echo e(route('admin_review_delete', $row->id)); ?>" class="btn btn-danger mb-md-0 mb-1" onClick="return confirm('Are you sure you want to delete this review?');" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                        </td>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/admin/review_view.blade.php ENDPATH**/ ?>