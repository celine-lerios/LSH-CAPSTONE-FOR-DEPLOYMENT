<?php $__env->startSection('heading', 'Add '.$accommodation->name.' Room'); ?>

<?php $__env->startSection('right_top_button'); ?>
<a href="<?php echo e(route('admin_room_view', $accommodation->id)); ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View All</a>
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('admin_room_store', $accommodation->id)); ?>" method="post" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="form-control" name="room_name" value="<?php echo e(old('room_name')); ?>">
                                </div>
                                <div class="mb-4">
                                    <label class="form-label">Description *</label>
                                    <textarea name="description" class="form-control h_100 snote"  cols="30" rows="10"><?php echo e(old('description')); ?></textarea>
                                </div>
                                <div class="mb-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/admin/room_add.blade.php ENDPATH**/ ?>