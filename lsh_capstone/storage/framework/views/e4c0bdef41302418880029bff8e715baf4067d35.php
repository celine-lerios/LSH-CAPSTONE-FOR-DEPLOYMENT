<?php $__env->startSection('heading', $accommodation->name.' Rooms'); ?>

<?php $__env->startSection('right_top_button'); ?>
<a href="<?php echo e(route('admin_room_add', $accommodation->id)); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/admin/room_view.blade.php ENDPATH**/ ?>