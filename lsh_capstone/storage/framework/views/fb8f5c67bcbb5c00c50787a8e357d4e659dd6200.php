                ...
                <div class="inner">
                    <div class="card accommodation-types-card">
                        ...
                        <div class="text card-body">
                            <h2><a href="<?php echo e(route('accommodation_detail',$item->id)); ?>"><?php echo e($item->name); ?></a></h2>
                            <div class="button">
...
<?php echo $__env->make('front.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/front/accommodation.blade.php ENDPATH**/ ?>