<?php $__env->startSection('heading', 'Room Gallery of '.$room_data->room_name); ?>

<?php $__env->startSection('right_top_button'); ?>
<a href="<?php echo e(route('admin_room_view',$room_data->accommodation_id )); ?>" class="btn btn-primary"><i class="fa fa-arrow-left"></i> Back to previous</a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/admin/room_gallery.blade.php ENDPATH**/ ?>