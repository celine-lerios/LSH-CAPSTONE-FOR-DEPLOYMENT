                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt_10 pb_10">
                                            ...
                                            <form action="<?php echo e(route('accommodation_booking_decline',$row->id)); ?>" method="POST" style="display:inline-block;">
                                                <?php echo csrf_field(); ?>
                                                <button type="submit" class="btn btn-danger mb-1" onClick="return confirm('Are you sure you want to decline the booking?');" data-toggle="tooltip" data-placement="top" title="Decline">
...
<?php echo $__env->make('accommodation.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/accommodation/pending_orders.blade.php ENDPATH**/ ?>