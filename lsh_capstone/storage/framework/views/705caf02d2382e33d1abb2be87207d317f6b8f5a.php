...
<div class="row">
    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
        <a href="<?php echo e(route('customer_order_view')); ?>">
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
        <a href="<?php echo e(route('customer_pending_order_view')); ?>">
            <div class="card card-statistic-1">
                <div class="card-icon bg-website">
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 col-12">
        <a href="<?php echo e(route('customer_room_review_view')); ?>">
            <div class="card card-statistic-1">
                <div class="card-icon bg-website">
...
<?php echo $__env->make('customer.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/customer/home.blade.php ENDPATH**/ ?>