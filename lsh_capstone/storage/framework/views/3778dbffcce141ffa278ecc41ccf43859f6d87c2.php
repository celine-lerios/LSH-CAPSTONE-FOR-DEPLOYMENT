                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="name" class="form-control" name="name" value="<?php echo e($testimonial_data->name); ?>">
                                </div>
                                <div class="mb-4">
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="comment"  cols="30" rows="10" class="form-control h_100"><?php echo e($testimonial_data->comment); ?></textarea>
                                </div>
                                <div class="mb-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/admin/testimonial_edit.blade.php ENDPATH**/ ?>