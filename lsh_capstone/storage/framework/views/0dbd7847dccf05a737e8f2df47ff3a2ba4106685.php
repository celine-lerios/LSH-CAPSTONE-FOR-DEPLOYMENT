<script src="<?php echo e(asset('dist/js/jquery-3.6.0.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('dist/js/bootstrap4-toggle.min.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/admin/layout/scripts.blade.php ENDPATH**/ ?>