...
<?php $__env->startSection('heading', 'Order Receipt'); ?>

<?php $__env->startSection('right_top_button'); ?>
<a href="<?php echo e(route('customer_order_view')); ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View All</a>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <address>
                                ...
                                <img src="<?php echo e(asset('uploads/'.Auth::guard('customer')->user()->photo)); ?>" alt="profile photo" class="w_50" ><br>
                                <?php echo e(Auth::guard('customer')->user()->name); ?><br>
                                <?php echo e(Auth::guard('customer')->user()->address); ?>,<br>
                                <?php echo e(Auth::guard('customer')->user()->city); ?>, <br>
                                <?php echo e(Auth::guard('customer')->user()->province); ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover table-md">
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo e(\Carbon\Carbon::createFromFormat('d/m/Y', $item->checkout_date)->format('F d, Y')); ?> 11:00 AM</td>
...
<?php echo $__env->make('customer.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/customer/invoice.blade.php ENDPATH**/ ?>