...
<?php $__env->startSection('heading', 'All Rooms'); ?>

<?php $__env->startSection('right_top_button'); ?>
<a href="<?php echo e(route('accommodation_room_add')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i> Add New</a>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="pt_10 pb_10">
                                            ...
                                            <a href="<?php echo e(route('accommodation_room_edit',$row->id)); ?>" class="btn btn-primary mb-1" data-toggle="tooltip" data-placement="top" title="Edit">
                                                <i class="fa fa-pencil" aria-hidden="true"></i>
                                            </a>
                                            <a href="<?php echo e(route('admin_room_delete',$row->id)); ?>" class="btn btn-danger" onClick="return confirm('Are you sure?');" data-toggle="tooltip" data-placement="top" title="Delete">
...
<?php echo $__env->make('accommodation.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/accommodation/room_view.blade.php ENDPATH**/ ?>