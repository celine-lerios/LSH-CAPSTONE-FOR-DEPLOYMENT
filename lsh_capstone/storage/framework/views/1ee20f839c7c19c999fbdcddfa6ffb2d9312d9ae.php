...
<?php $__env->startSection('heading', 'Add Review for '.$accommodation->name); ?>

<?php $__env->startSection('right_top_button'); ?>
<a href="<?php echo e(route('customer_review_view')); ?>" class="btn btn-primary"><i class="fa fa-eye"></i> View All</a>
...
<div class="section-body">
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('customer_review_submit', $accommodation->id)); ?>" method="post">
                        <?php echo csrf_field(); ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-4">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('customer.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\LSH_Version_2-main\lsh_capstone\resources\views/customer/review_add.blade.php ENDPATH**/ ?>