...
<script src="<?php echo e(asset('dist-front/js/sticky-sidebar.js')); ?>"></script>
<script src="<?php echo e(asset('dist-front/js/jquery.meanmenu.js')); ?>"></script>
<script src="<?php echo e(asset('dist-front/js/iziToast.min.js')); ?>"></script><?php /**PATH C:\Users\ASUS\OneDrive\Documents\GitHub\LSH-CAPSTONE-FOR-DEPLOYMENT\lsh_capstone\resources\views/front/layout/scripts.blade.php ENDPATH**/ ?>